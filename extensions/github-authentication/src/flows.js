...
exports.isSocialSignInProvider = exports.getFlows = void 0;
...
function isSocialSignInProvider(provider) {
    return provider === "google" /* GitHubSocialSignInProvider.Google */; // || provider === GitHubSocialSignInProvider.Apple;
}
