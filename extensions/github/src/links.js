...
exports.ensurePublished = exports.getVscodeDevHost = exports.getCommitLink = exports.getBranchLink = exports.getAvatarLink = exports.getLink = exports.encodeURIComponentExceptSlashes = exports.notebookCellRangeString = exports.rangeString = exports.getRepositoryForFile = exports.isFileInRepo = void 0;
...
async function getLink(gitAPI, useSelection, shouldEnsurePublished, hostPrefix, linkType = 'permalink', context, useRange) {
    ...
    const githubRepository = gitAPI.repositories.find(repo => (0, util_js_1.repositoryHasGitHubRemote)(repo));
...
function getBranchLink(url, branch, hostPrefix = 'https://github.com') {
    const repo = (0, util_js_1.getRepositoryFromUrl)(url);
    if (!repo) {
